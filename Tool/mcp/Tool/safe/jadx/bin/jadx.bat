...
set DEFAULT_JVM_OPTS="-Xms256M" "-XX:MaxRAMPercentage=70.0" "-Djdk.util.zip.disableZip64ExtraFieldValidation=true"
...
set CLASSPATH=%APP_HOME%\lib\jadx-1.5.6-all.jar
